...
@SpringBootTest
public class RemoveArticleTest {
    @Autowired
    ...
    public void test() {
        ...
        assertDoesNotThrow(() -> articleService.removeArticle(article.getId()));
        assertThrows(ServiceException.class, () -> articleService.getArticleById(article.getId()));
    }
}
