...
public class CreateArticleTest {
    ...
    public void test() {
        ...
        assertEquals(article.getContent(), "test");
        assertEquals(ArticleDateConverter.getStringByInstant(article.getPublishDate()), "2022-01-07 10:10:10");
        assertEquals(article.getAuthor().getId(), user.getId());
    }
}
