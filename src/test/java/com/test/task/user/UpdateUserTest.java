...
public class UpdateUserTest {
    ...
    public void test() {
        ...
        updateUserRequest.setPassword(new String(Base64.getEncoder().encode("testUpdate".getBytes())));
        ...
        assertEquals(updatedUser.getLogin(), "testUpdate");
        assertEquals(updatedUser.getRole(), UserRole.ADMIN);
    }
}
